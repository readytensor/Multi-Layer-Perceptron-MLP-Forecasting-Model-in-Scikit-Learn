...
- Run the script `src/train.py` to train the Multi-Layer Perceptron (MLP) classifier model. This will save the model artifacts, including the preprocessing pipeline and label encoder, in the path `./model_inputs_outputs/model/artifacts/`.
